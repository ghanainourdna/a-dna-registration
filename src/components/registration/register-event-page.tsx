        ...
        <div className="relative z-10 mx-auto w-full max-w-[min(115rem,calc(100%-2rem))] min-w-0 px-4 pb-12 pt-14 max-md:pb-10 max-md:pt-12 sm:px-6 md:pb-16 md:pt-20 md:px-10">
          <div className="grid min-w-0 gap-10 lg:grid-cols-[minmax(0,1fr)_min(360px,calc(100vw-18rem))] lg:items-end lg:gap-12 xl:gap-14">
            <div className="max-w-[40rem] space-y-5 text-white">
              ...
              >
                <span
                  className="flex h-1.5 w-8 shrink-0 overflow-hidden rounded-full"
                  aria-hidden
                >
              ...
              {conference.theme ? (
                <p className="max-w-xl text-sm leading-relaxed text-emerald-100/90 sm:text-[0.95rem]">
                  <span className="font-semibold uppercase tracking-[0.12em] text-emerald-200/80">
                    Theme
                  </span>
                  <span className="mt-1 block">{conference.theme}</span>
                </p>
              ) : null}

              <ul
                className="flex max-w-xl flex-wrap gap-2 pt-1"
                aria-label="Conference details"
              >
                <li className="inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/[0.08] px-3 py-2 text-[13px] font-medium leading-tight text-stone-100 shadow-sm backdrop-blur-sm sm:text-sm">
                  <CalendarIcon />
                  {conference.dates_label}
                </li>
                <li className="inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/[0.08] px-3 py-2 text-[13px] font-medium leading-tight text-stone-100 shadow-sm backdrop-blur-sm sm:text-sm">
                  <LocationIcon />
                  {conference.location_label}
                </li>
                {conference.reception_label ? (
          ...
          <p className="mt-8 flex justify-center text-center md:mt-12">
            <span className="inline-flex max-w-[min(100%,28rem)] items-center gap-2 rounded-full border border-white/12 bg-black/30 px-3 py-2 text-[10px] font-semibold uppercase leading-none tracking-[0.18em] text-white/70 backdrop-blur-md sm:text-[11px] sm:tracking-[0.2em]">
              <span
                className="size-1.5 shrink-0 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(52,211,153,0.75)] motion-safe:animate-pulse"
                aria-hidden
              />
        ...
        <div className="min-w-0 overflow-hidden rounded-2xl border border-stone-200/80 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-12px_rgba(15,23,42,0.08)] ring-1 ring-stone-950/[0.03] md:rounded-[1.35rem]">
          ...
          <div className="grid min-w-0 md:grid-cols-[minmax(0,1.08fr)_minmax(0,1fr)] md:items-stretch">
            <div className="relative aspect-[5/4] w-full max-h-[min(72dvh,28rem)] min-h-[12.5rem] overflow-hidden bg-stone-200 sm:aspect-[16/10] sm:max-h-[min(64dvh,32rem)] md:aspect-auto md:max-h-none md:min-h-[min(340px,50vh)]">
              ...
              />
              <div
                className="pointer-events-none absolute inset-x-0 bottom-0 z-1 h-20 bg-linear-to-t from-black/35 to-transparent md:hidden"
                aria-hidden
              />
            </div>
            ...
            <div className="relative flex min-w-0 flex-col justify-center border-t border-stone-100/90 bg-white px-4 py-5 sm:px-7 sm:py-7 md:border-t-0 md:border-l md:border-stone-100/90 md:px-8 lg:px-10 lg:py-9">
              <div className="flex max-w-full flex-wrap items-center gap-2 rounded-full border border-emerald-200/90 bg-emerald-50/80 px-2.5 py-1.5 ring-4 ring-emerald-50/60">
                <span
                  className="size-1.5 shrink-0 rounded-full bg-emerald-600 shadow-[0_0_0_2px_rgba(5,150,105,0.2)]"
                  aria-hidden
                />
              ...
              <p className="mt-4 max-w-[62ch] text-sm leading-relaxed text-stone-600">
                A-DNA lifts up nurses and health leaders of African diaspora
                descent, from mentorship and scholarships to advocacy and global
                health partnerships. Gatherings such as our fundraiser in Ghana
                set the tone: clinicians, patrons, and allies advancing equity
                together.
              </p>
                ...
                {(
                  [
                    [
                      ...
                      "Grow the next generation of diaspora clinician-leaders",
                    ],
                    [
                      "Policy & advocacy",
                      "Evidence-informed voice for underserved communities worldwide",
                    ],
                    [
                      "Global gatherings",
                      "Conferences and fundraisers that deepen cross-border ties",
                    ],
                  ] as const
                ).map(([title, detail]) => (
                  <li
              ...
              <p className="mt-8 border-t border-stone-100/90 pt-5 text-xs leading-relaxed text-stone-500">
                <span className="font-medium text-stone-600">Photos</span> ·
                African-Diaspora Nursing Alliance (A-DNA) community events and
                gatherings, same spirit we bring to {conference.title}.
              </p>
            </div>
          </div>
        </div>
