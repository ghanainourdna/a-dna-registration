-- ISO 3166-1 alpha-2 countries (name + code)

create table if not exists public.countries (
  code char(2) primary key constraint countries_code_upper check (code ~ '^[A-Z]{2}$'),
  name text not null unique
);

comment on table public.countries is 'Reference list for attendee country selection';
